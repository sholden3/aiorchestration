...
- [Angular Application Module](../../ai-assistant/src/app/app.module.ts)
- [Application Configuration](../../ai-assistant/src/environments/environment.ts)
- [Terminal Service Implementation](../../ai-assistant/src/app/services/terminal.service.ts)
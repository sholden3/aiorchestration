    ...
    def check_source_documentation(self):
        ...
        try:
            if UNIFIED_VALIDATOR_AVAILABLE:
                ...
                from libs.governance.validators.unified_doc_validator import UnifiedDocumentValidator as CodeDocumentationValidator
            else:
    ...
    def check_documentation_validation(self):
        ...
        try:
            ...
            if UNIFIED_VALIDATOR_AVAILABLE:
                ...
                from libs.governance.validators.unified_doc_validator import UnifiedDocumentValidator as DocumentationValidator
            else:
                from libs.governance.validators.doc_validator import DocumentationValidator
